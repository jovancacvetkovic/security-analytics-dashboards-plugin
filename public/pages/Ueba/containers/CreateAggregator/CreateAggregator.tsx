...
export const CreateAggregator: React.FC<UebaProps> = ({ history }) => {
  ...
  return (
    <form onSubmit={formik.handleSubmit}>
      ...
      <EuiText size="s" color="subdued">
        Any additional text about aggregators.
      </EuiText>
      <EuiSpacer size={'m'} />

      <ContentPanel title={'Aggregator details'} titleSize={'m'}>
        <EuiSpacer size={'m'} />
        <EuiFormRow
      ...
      <Schedule title={'Aggregator schedule'} onScheduleChange={() => {}} schedule={{}} />
